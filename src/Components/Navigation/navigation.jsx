          ...
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-center">
                ...
                <button
                  type="button"
                  className="relative rounded-full bg-white p-1 sm:ml-6 w-10 relative"
                >
                  <svg
                    fill="#000000"
                    version="1.1"
                  ...
                  <div className="rounded-3xl bg-red-600 d-flex justify-center align-middle w-5 absolute bottom-0 right-0 translate-x-3 -translate-y-2">
                    3
                  </div>
                </button>
              </div>
